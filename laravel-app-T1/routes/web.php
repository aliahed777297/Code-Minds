...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        // admin resources: users, orders, messages
        ...
        Route::resource('users', \App\Http\Controllers\Admin\UserController::class)->only(['index','show','destroy'])->names([
            'index' => 'users.index',
            'show' => 'users.show',
            'destroy' => 'users.destroy',
        ])->parameters(['users' => 'user']);

        Route::resource('messages', \App\Http\Controllers\Admin\ContactMessageController::class)->only(['index','show','destroy'])->names([
